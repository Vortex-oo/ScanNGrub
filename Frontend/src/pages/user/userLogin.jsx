...
import { loginSuccess } from '../../Slices/userSlices.js';
    ...
    return (
        <div className='w-full h-screen bg-black px-4 py-14'>
            <div className='text-white font-bold text-6xl'>
                <h1 ref={(el) => (textRef.current[0] = el)}>Hey,</h1>
                <h1 ref={(el) => (textRef.current[1] = el)}>Welcome</h1>
                <h1 ref={(el) => (textRef.current[2] = el)}>Back</h1>
            </div>
            ...
            <div className="text-center mt-6 flex justify-center gap-1" ref={newUserRef}>
                ...
                <Link to="/user/signup" className="text-[#d28de8]">
